...
<div class="container">
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
                <th scope="row">Phone</th><td scope="row">: <input type="text" value="{{$user->phone}}" name="phone"></td>
            </tr>
            <tr>
    ...
    <a href="{{route('admin.agent', $user->name)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">Zurück</a>
    </div>
