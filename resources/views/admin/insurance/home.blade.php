...
<form action="{{route('admin.form.home')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="card">
            <div class="card-body">
        ...
        <div class="row">
           ...
           <div class="col-6">
            ...
            <div class="card-body">
                ...
                <div class="row p-2">
                    <div class="col-6">
                      <label class="col-form-label">Von einer Versicherung gekündigt / abgelehnt?</label>
                    </div>
                    <div class="col-6">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
              <label class="col-form-label">Bemerkungen</label>
            </div>
            <div class="col-6">
