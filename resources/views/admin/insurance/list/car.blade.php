...
@section('insurance')
    ...
    <table class="table" id="table">
        ...
        @php
            $car = App\CarInsurance::where('user_id', auth()->id())->get();
        @endphp
        <tbody>
        ...
        @endphp
          <tr>
            ...
            <td><a href="{{route('admin.view.insurance.car', $value->insurance_number)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3"> Öffnen </a></td>
            <td>
            ...
            <td>
                {{-- <a href="{{route('mail.car', $value->insurance_number)}}" class="btn btn-outline-danger"> Senden </a> --}}
                <form action="{{route('mail.cars')}}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="Pannenhilfe" value="{{$value->Pannenhilfe}}">
            ...
            <td>
                <form action="{{ route('admin.insurance.car.delete', $value->id) }}" method="post">
                    @method('post')
                    @csrf
