...
<form action="{{route('admin.form.travel.update', $item->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="card">
            <div class="card-body">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <select name="insurance_email_b" class="form-control">
                    <option selected value="{{ $item->company_email }}">{{ $item->company_name }}</option>
                    <option value="admin@ibrs.ch"> keine </option>
                    @foreach (App\InsuranceCompany::all() as $company)
                    <option value="{{ $company->company_email }}">{{ $company->company_name }}</option>
                    @endforeach
                </select>
               ...
               <div class="col-6">
                ...
                <div class="card-body">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-6">
                            <input type="checkbox" class="form-check-input" value="Ja" name="begin" autocomplete="off"/>
                            <label class="form-check-label" for="form-check-input">Ja</label>

                            <input type="checkbox" class="form-check-input" value="Nein" name="begin" autocomplete="off"/>
                            <label class="form-check-label" for="form-check-input2">Nein</label>
                        </div>
                    </div>
