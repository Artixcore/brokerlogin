...
<form action="{{route('admin.form.law.update', $item->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="card">
            <div class="card-body">
        ...
        <div class="card-body">
            ...
            <textarea type="text" class="form-control" name="comments">{{ $item->comments }}
            </textarea>
        </div>
        </div>
