    ...
    <table class="table" id="table">
        ...
        @endphp
          <tr>
            ...
            <td><a href="{{route('admin.form.law.edit', $value->law_number)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3"> Öffnen </a></td>
            <td>
            ...
            <td>
                <form action="{{ route('admin.form.law.delete', $value->id) }}" method="post">
                    @method('post')
                    @csrf
