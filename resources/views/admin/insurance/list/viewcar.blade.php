...
<form action="{{route('admin.post.insurance.car' ,$in->id)}}" method="post">
    @csrf
    <div class="container">
        <div class="card">
            <div class="card-body">
        <div class="row">
            ...
            <div class="col-4">
                <label class="form-label">Unternehmen auswählen</label>
            ...
            <div class="row">
               <div class="col-6">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-6">
                        <input type="checkbox" class="form-check-input" value="Ja" name="partially_deductible"  autocomplete="off"/>
                        <label class="form-check-label" for="form-check-input">Ja</label>
               ...
               <div class="col-6">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-6">
                        <input type="checkbox" class="form-check-input" value="Ja" name="insurance_parkschaden" autocomplete="off"/>
                        <label class="form-check-label" for="form-check-input">Ja</label>
