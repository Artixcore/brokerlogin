...
<form action="{{route('admin.form.car')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="card">
            <div class="card-body">
               ...
               <div class="col-6">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="form-check-label" for="form-check-input">0.-</label>
                        <input type="checkbox" class="form-check-input" value="200.-" name="partially_deductible" id="form-check-input2" autocomplete="off"/>
                        <label class="form-check-label" for="form-check-input2">200.-</label>
                        <input type="checkbox" class="form-check-input" value="500.-" name="partially_deductible" id="form-check-input2" autocomplete="off"/>
