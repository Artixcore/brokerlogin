...
<div class="container">
     ...
     <div class="card-footer">
            ...
            <button type="submit" style="float:left;" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">Speichern</button>
        </form>

        <form action="{{ route('nachweis.delete', $in->id)}}" method="post">
            @method('post')
            @csrf
            <button style="float: right;" onclick="return myFunction();" type="submit" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i></button>
        </form>
...
<div class="modal fade" id="Nachweis" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="mb-3">
    ...
    <input name="inv" type="date" class="form-control">
    </div>

    <div class="mb-3">
    <label class="form-label">Kontrollschild</label>
    <input name="kontrollschild" type="text" class="form-control">
    </div>
    ...
    <div class="md-3">
        ...
        <select name="grund" class="form-control">
