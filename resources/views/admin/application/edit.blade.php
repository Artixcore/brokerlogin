...
<div class="container">
        <div class="row">
                <div class="col-4">
                    ...
                    <form method="post" action="{{route('admin.customer.edit', $cus->id)}}">
                        @csrf
                    <div class="card-body">
                        <table class="table">
                          <thead>
                            ...
                            @php
                                ...
                                $ag = App\User::where('urole', 'author')->get();
                            @endphp
                                <th>
                                   : <select name="user_id">
                                        <option selected>
                            ...
                            <th scope="col">Geburtstag</th>
                                <th>: <input type="date" name="customer_date_of_birth" value="{{ date('d.m.Y', strtotime($cus->customer_date_of_birth)) }}" required></th>
                              </tr>
                          </thead>
                        </table>
                    </div>
                    ...
                    <a href="{{route('application.offer', $cus->customer_number)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">Back</a>
                    </div>
