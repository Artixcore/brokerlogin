        ...
        <div class="row">
                        ...
                        <table class="table table-hover" id="table1">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="{{route('admin.contact.view.app', $in->application_number)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">Öffnen </a></td>
                                <td>
                ...
                <div class="col-4">
                    ...
                    <div class="card-body">
                      <table class="table">
                        <thead>
                          <tr>
                            <th>Surename</th>
                            <th>: {{ $in->customer_name }}</th>
                          </tr>
                          <tr>
                            <th>First Name</th>
                            <th>: {{ $in->customer_f_name }}</th>
                          </tr>
                          <tr>
                            <th>Email</th>
                            <th>: {{ $in->customer_email }}</th>
                          </tr>
                          <tr>
                            <th>Phone</th>
                            <th>: {{ $in->customer_phone }}</th>
                          </tr>
                          <tr>
                            <th>Category</th>
                            <th>: {{ $in->insurance_type }}</th>
                          </tr>
                    ...
                    <div class="card" style="height:50%;">
                        ...
                        <iframe src="{{asset('public/pdfs/uploads')}}/{{ $in->insurance_doc }}" style="height:50%;" title="PDF"></iframe>
