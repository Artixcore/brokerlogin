                ...
                <div class="col-xl-12 col-xxl-12 d-flex">
                    <div class="w-100">
                        <div class="row">
                            ...
                            <a href="{{route('broker.insurance.form')}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">
                                New Insurance
                            </a>
                            </div>
                            <div class="card-body">
                            <table class="table table-hover my-0" id="table">
                                ...
                                {{-- @foreach ($task as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell"><button class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3"><i class="fas fa-link"></i></button></td>
                                        <td class="d-none d-md-table-cell"><button class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3">Active</button></td>
                                    </tr>
