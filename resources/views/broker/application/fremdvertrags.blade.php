...
<div class="card-header">
    ...
    <div class="card-body">
        ...
        <table class="table" id="table">
            ...
            @php
            $for = App\Fremdvertrag::where('user_id', auth()->id())->get();
            @endphp
            <tbody>
...
<tr>
    ...
    <td>
        ...
        @endphp
                ...
                <td>
                    <a href="{{route('broker.fremdvertrag.edit', $in->con_number)}}" class="btn btn-outline-default" style="color:#000000; background-color:#D3D3D3"> Öffnen  </a>
                </td>

                {{-- <td>
                    <form action="{{ route('broker.fremdvertrag.delete', $in->id) }}" method="post">
                        @method('post')
                        @csrf
