                        ...
                        <table class="table">
                          <thead>
                            ...
                            <th scope="col">Berater</th>
                              @php
                                $ag = App\User::where('id', $cus->user_id)->get();
                              @endphp
                            <td>
                              @foreach ($ag as $it)
                                  {{ $it->name }}
              ...
              @endforeach
                    ...
                    <table class="table">
                      <thead>
                        ...
                        <tr>
                          ...
                          <td> {{ date('d.m.Y', strtotime($in->beginning)) }}</td>
                        </tr>
                        <tr>
                ...
                <div class="col-4">
                    ...
                    <div class="card" style="height:100%;">
                        ...
                        <iframe src="{{asset('public/pdfs/uploads')}}/{{ $in->insurance_doc }}" style="height:100%;" title="PDF"></iframe>
...
<div class="modal fade" id="Fremdvertrag" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{route('broker.fremdvertrag.post')}}" enctype="multipart/form-data" method="POST">
            @csrf
...
<div class="modal fade" id="docs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  {{-- <div class="mb-3">
    ...
    <select name="doc_comment" class="form-control">
        <option selected>Select One..</option>
