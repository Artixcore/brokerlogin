...
class InsuranceController extends Controller
{
    ...
    function insurance(){
        ...
        return view('broker.insurance.all');
    }
    ...
    function home(){
        return view('broker.insurance.home');
    }

    function car_list(){
        return view('broker.insurance.list.car');
    }

    function view_single_car($insurance_number){
        $insurance = CarInsurance::where('insurance_number', $insurance_number)->get();
        return view('broker.insurance.list.viewcar', compact('insurance'));
    }


    function home_list(){
        return view('broker.insurance.list.home');
    }

    function view_single_home($insurance_number){
        $insurance = HomeInsurance::where('insurance_number', $insurance_number)->get();
        return view('broker.insurance.list.viewhome', compact('insurance'));
    }


        // Travel
        function travel(){
            return view('broker.insurance.travel');
        }

        function travel_list(){
            $list = Travel::where('user_id', auth()->id())->get();
            return view('broker.insurance.list.travel', compact('list'));
        }

        function travel_edit($travel_number){
            $travel = Travel::where('travel_number', $travel_number)->get();
            return view('broker.insurance.list.viewtravel', compact('travel'));
        }
        ...
        function travel_update(Request $request, $id){
            ...
            return redirect()->route('broker.form.law.list')->with('success', 'Gespeichert');
        }
    ...
    function law(){
        return view('broker.insurance.law');
    }

    function law_list(){
        $list = Law::where('user_id', auth()->id())->get();
        return view('broker.insurance.list.law', compact('list'));
    }
    ...
    function law_edit($law_number){
        ...
        return view('broker.insurance.list.viewlaw', compact('law'));
    }
    ...
    function car(){
        return view('broker.insurance.car');
    }
    ...
    function business(){
        return view('broker.insurance.business');
    }

    function company_health(){
        return view('broker.insurance.health');
    }
